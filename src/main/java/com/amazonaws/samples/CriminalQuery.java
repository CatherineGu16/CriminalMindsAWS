...
public class CriminalQuery {
	...
	public static void main(String args[])
	{
		...
		String name = "Ted Bundy";
		
		resultquery = queryCriminal(name, 1);
		// 1 - query by name
	...
	public static ArrayList<Item> queryCriminal(String fieldname, int queryType) {
	    ...
	    case 5:
	    	//Query by Age
	    	int Age = Integer.parseInt(fieldname);
