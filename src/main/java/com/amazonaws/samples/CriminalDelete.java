...
public class CriminalDelete {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String prisonerName = "Ted Bundy";
        
        DeleteItemSpec deleteItemSpec = new DeleteItemSpec()
        	.withPrimaryKey(new PrimaryKey("Prisoner#", prisonerNumber, "1 Name", prisonerName));


        /*DeleteItemSpec deleteItemSpec = new DeleteItemSpec()
            .withPrimaryKey(new PrimaryKey("year", year, "title", title)).withConditionExpression("info.rating <= :val")
            .withValueMap(new ValueMap().withNumber(":val", 6.0));*/
